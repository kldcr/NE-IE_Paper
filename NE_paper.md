Network Embedding(NE) or Network Representation Learning(NRL) aims to learn low-dimensional vector representation for nodes in network with network topology and node content information.
