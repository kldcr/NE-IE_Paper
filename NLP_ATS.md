...
||论文题目|作者|发表年份|会议|论文链接|代码链接|注释|引用次数|
|-|------|----|-------|----------|-------|----|---|---|
|1|Multi-modal Sentence Summarization with Modality Attention and Image Filtering ||2018|IJCAI|[paper](https://www.ijcai.org/proceedings/2018/0577.pdf)|||2|
|2|A Reinforced Topic-Aware Convolutional Sequence-to-Sequence Model for Abstractive Text Summarization ||2018|IJCAI|[paper](https://arxiv.org/pdf/1805.03616.pdf)|||9|
...
|7|Neural Related Work Summarization with a Joint Context-driven Attention Mechanism. ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1204)|||0|
|8|Improving Neural Abstractive Document Summarization with Explicit Information Selection Modeling ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1205)|||0|
|9|Don't Give Me the Details, Just the Summary! Topic-Aware Convolutional Neural Networks for Extreme Summarization. ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1206)|[code](https://github.com/EdinburghNLP/XSum)||1|
|10|Improving Abstraction in Text Summarization. ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1207)||4|
|11|Content Selection in Deep Learning Models of Summarization. ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1208)|||4|
|12|Keyphrase Generation with Correlation Constraints ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1439)|||2|
|13|Closed-Book Training to Improve Summarization Encoder Memory ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1440)|||1|
|14|Improving Neural Abstractive Document Summarization with Structural Regularization ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1441)|||0|
|15|Iterative Document Representation Learning Towards Summarization with Polishing ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1442)|||1|
|16|Bottom-Up Abstractive Summarization ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1443)|[code](https://github.com/sebastianGehrmann/bottom-up-summary)||5|
|17|Controlling Length in Abstractive Summarization Using a Convolutional Neural Network ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1444)|||0|
|18|APRIL: Interactively Learning to Summarise by Combining Active Preference Learning and Reinforcement Learning ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1445)|||0|
|19|Adapting the Neural Encoder-Decoder Framework from Single to Multi-Document Summarization ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1446)|[code](https://github.com/ucfnlp/multidoc_summarization)||1|
|20|Semi-Supervised Learning for Neural Keyphrase Generation. ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1447)|||2|
|21|MSMO: Multimodal Summarization with Multimodal Output ||2018|EMNLP|[paper](http://aclweb.org/anthology/D18-1448)|||0|
...
|30|Neural summarization by extracting sentences and words.|Cheng J, Lapata M|2016|ACL|[paper](https://arxiv.org/pdf/1603.07252.pdf)|hierarchical + Attention [code](https://github.com/cheng6076/NeuralSum)|
